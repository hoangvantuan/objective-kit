...
Đọc `okr-guide.md` để check tiêu chí. Đối chiếu lessons loại B đã nạp (Preload Contract, area liên quan, vd "định nghĩa KR", "baseline"): nếu có bài học về đặt KR/baseline cho project này, áp dụng (xem `../../okr-shared/references/preload.md` "Áp dụng lessons").
