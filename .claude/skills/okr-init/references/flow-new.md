...
Đọc `okr-guide.md` để check tiêu chí. Đối chiếu lessons loại B đã auto-load (area liên quan, vd "định nghĩa KR", "baseline"): nếu có bài học về đặt KR/baseline cho project này, áp dụng (xem `okr-shared` "Áp dụng lessons").
